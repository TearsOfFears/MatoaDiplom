...
const MenageHomePage = () => {
	...
	const { contentProduct, contentTestimonals, contentInstagram,contentEdit } = content;
	...
	const { dataInstagram, queryDocInstagram, isLastPageInstagram } = contentInstagram;
			...
			<Modal {...configModal}>
				<FormSelect
					options={[
						...
						{
							value: 3,
							name: "Добавити фотографії інстаграму",
						},
					]}
					value={active}
				...
				<div className="addNewProductForm">
					{active === 1 && (
						<MenageHomeProducts contentEdit={contentEdit} />
					)} 
					{active === 2 && (
						<MenageHomeTestimonals contentEdit={contentEdit} />
					)} 
					{active === 3 && (
						<MenageHomeInstagram contentEdit={contentEdit} />
					)}
				</div>
			</Modal>
			<TableContainer>
								...
								return (
									<TableRow key={documentId} style={styles}>
										...
										<TableCell align="left">
											<button
												className="delete"
												onClick={() => handleGetContentInstagram(documentId)}
											>
												<svg
													xmlns="http://www.w3.org/2000/svg"
													width="17"
