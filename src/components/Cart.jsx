...
function Cart() {
  return (
    <section className="cart animate__animated ">
    <div className="cart-modal">
      <div className="cart-item">
        <div className="img-title">
          <div className="img-wrapper">
            <img src="../../img/home/maple-1.png" alt="">
          </div>
        ...
        <div className="plus-minus-delete">
          <div className="block-minus-plus">
            <button className="minus"><svg width="16" height="2" viewBox="0 0 16 2" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M0 1H16" stroke="none" />
              </svg>
            </button>
            <span>1</span>
            <button className="plus"><svg width="16" height="16" viewBox="0 0 16 16" fill="#777"
                xmlns="http://www.w3.org/2000/svg">
          ...
          <button className="delete"> <svg width="17" height="19" viewBox="0 0 17 19" fill="#d84727"
              xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="cart-item">
        ...
        <div className="wrapper-checkout mt-4">
            ...
            <div className="btn-read w-100 text-center">
                Chekout
            </div>
        </div>
    </div>
